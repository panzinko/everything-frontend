...
const Characters = () => {
  const { searchTerm, isLoading, error, characters, handleSearch } = useCharacterSearch();
  ...
  return (
    <div className="space-y-4">
      ...
      {error && <div className="bg-red-50 text-red-500 p-4 rounded-lg">{error.message}</div>}
